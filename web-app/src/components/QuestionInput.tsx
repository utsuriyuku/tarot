...
export default function QuestionInput({ onSubmit, isVisible }: QuestionInputProps) {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="rounded-[28px] border border-[#8f6d41]/18 bg-[linear-gradient(180deg,rgba(25,18,13,0.92),rgba(14,10,8,0.88))] p-3 shadow-[0_24px_80px_rgba(0,0,0,0.48)] backdrop-blur-2xl md:p-4">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          <input
            ...
            className="h-14 flex-1 rounded-2xl border border-[#8f6d41]/16 bg-[#1a130f]/85 px-5 text-[15px] text-[#f3e8d5] outline-none transition placeholder:text-[#b69d76]/45 focus:border-[#caa15e]/45 focus:bg-[#201712] focus:shadow-[0_0_0_1px_rgba(202,161,94,0.18)]"
          />
          <button
            type="submit"
